...
const Sidebar = () => {
  const sidebarItems = [
    ...
    {
      icon: <Avatar size={"sm"} name='Raymond Adoe' src='/profilepic.png' />,
      text: "Profile",
      link: "/asaprogrammer",
    },
  ];
  return (
    ...
    <Flex direction={"column"} gap={10} w="full" height="full">
      ...
      <Link top={"/"} as={RouterLink} pl={2} display={{base:"block", md:"none"}} borderRadius={6} _hover={{bg:"whiteAlpha.200"}} w={10} cursor="pointer">
        <InstagramMobileLogo />
      </Link>
